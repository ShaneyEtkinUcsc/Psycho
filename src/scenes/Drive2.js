    ...
    create() {
       ...
       let carBounce = this.tweens.chain({
        ...
        this.boxBundle1 = new dialogBoxBundle(this, [
            ...
            ['sound', "audio23"],
            ['bottom2', "Carolin, Marion still isn't in yet?"],
            ['sound', "audio24"],
            ['bottom2', "No Mr. Lowrey, but then again she's always a bit late on Monday mornings."],
            ['sound', "audio25"],
        ...
        this.boxBundle2 = new dialogBoxBundle(this, [
            ...
            ['sound', "audio27"],
            ['bottom2', "I called her sister Mr. Lowrey, where she works. The music maker's music store you know,"],
            ['sound', "audio28"],
            ['bottom2', "and she doesn't know where Marion is any more than we do."],
            ['sound', "audio29"],
        ...
        this.boxBundle3 = new dialogBoxBundle(this, [
            ...
            ['sound', "audio36"],
            ['bottom2', "Carolin, get Mr. Cassidy for me."],
            ['end', "talk3"]
        ], true);

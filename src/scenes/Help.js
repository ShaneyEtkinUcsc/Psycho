class Help extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(centerX, centerY, 'INSERT INSTRUCTIONS HERE', helpConfig).setOrigin(0.5);
        this.add.text(centerX, centerY + 50, "INSERT MORE INSTRUCTIONS", helpConfig).setOrigin(0.5);
